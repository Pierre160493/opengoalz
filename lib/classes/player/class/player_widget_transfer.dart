...
//               ),
//             ),
//             if (idClub != Provider.of<SessionProvider>(context).selectedClub.id)
//               IconButton(
//                 icon: Icon(
...
//               ),
//               Text(
//                   'Available cash: ${NumberFormat('#,###').format(Provider.of<SessionProvider>(context, listen: false).selectedClub.cashAvailable)}'),
//             ],
//           ),
//           actions: <Widget>[
//             TextButton(
