          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'League ${(100 * games.where((Game game) => game.dateEnd != null).length / 30).round() > 100 ? 'Fully played' : (100 * games.where((Game game) => game.dateEnd != null).length / 30).round().toString() + ' % played'}',
