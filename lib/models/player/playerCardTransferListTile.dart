...
// class PlayerCardTransferWidget extends StatefulWidget {
//   final Player player;
...
//   @override
//   _PlayerCardTransferWidgetState createState() =>
//       _PlayerCardTransferWidgetState();
// }

// class _PlayerCardTransferWidgetState extends State<PlayerCardTransferWidget> {
//   @override
//   Widget build(BuildContext context) {
//     return _buildPlayerCardTransferWidget(widget.player);
//   }

//   Widget _buildPlayerCardTransferWidget(Player player) {
//     return ListTile(
//       shape: RoundedRectangleBorder(
//         borderRadius: BorderRadius.circular(12),
//         side: const BorderSide(color: Colors.blueGrey),
