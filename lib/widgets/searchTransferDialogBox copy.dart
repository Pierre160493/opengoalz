...
// class searchPlayerDialogBox extends StatefulWidget {
//   final InputCriterias inputInputCriterias;
//   searchPlayerDialogBox({required this.inputInputCriterias});
//   @override
//   _searchPlayerDialogBoxState createState() => _searchPlayerDialogBoxState();
// }

// class _searchPlayerDialogBoxState extends State<searchPlayerDialogBox> {
...
//   InputCriterias inputCriterias = InputCriterias();
...
//     inputCriterias = widget.inputInputCriterias;
...
//                     if (selectedStatus == PlayerStatus.transferList)
//                       'date_sell': null,
//                     if (selectedStatus == PlayerStatus.freePlayer)
//                       'free_player': null,
//                     if (minDateBirth != null)
//                       'date_birth_min': minDateBirth!.toIso8601String(),
//                     if (maxDateBirth != null)
//                       'date_birth_max': maxDateBirth!.toIso8601String(),
//                   };

//                   // if (selectedStatus != PlayerStatus.transferList) {
//                   //   inputCriteria['date_sell'] = [selectedStatus.index];
//                   // }

//                   /// Open the Players Page with the selected filters
//                   Navigator.of(context).pop();
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                         builder: (context) =>
//                             PlayersPage(inputCriteria: inputCriterias)),
//                   );
//                 },
//                 child: Row(
//                   children: [
