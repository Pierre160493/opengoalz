...
class PlayerTransferBidDialogBox extends StatefulWidget {
  final Stream<Player> playerStream;
  PlayerTransferBidDialogBox({required this.playerStream});
  @override
...
class _PlayerTransferBidDialogBoxState
  ...
  void _validateBid() {
    setState(() {
      ...
      if (bidAmount == null || _player == null) {
        _isValidBid = false;
        return;
      }
      ...
      final int availableCash =
          Provider.of<SessionProvider>(context, listen: false)
              ...
              .selectedClub!
              .cash;
      final int? currentHighestBid = _player!.transferBids.length == 1
          ? null
          : _player!.transferBids.last.amount;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<Player>(
      ...
      builder: (context, snapshot) {
        ...
        if (_player!.transferBids.isEmpty) {
          throw Exception('No bids available for this player.');
        }
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: currentHighestBid == null
                          ? null
                          : Text('By: ${_player!.transferBids.last.nameClub}'),
                    ),
                    ListTile(
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12.0),
