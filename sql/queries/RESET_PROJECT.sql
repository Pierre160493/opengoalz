...
BEGIN
    ...
    (3, date_trunc('week', CURRENT_DATE) + INTERVAL '20 hours' - interval '1 week', 7, 'The Lucky Seven'), -- 1 game per day
    (4, date_trunc('week', CURRENT_DATE) + INTERVAL '20 hours' - interval '1 week', 14, 'The Double Seven'), -- 2 games per day
    (5, date_trunc('day', CURRENT_DATE), 168, 'The Very Fast'), -- Every hour
    (6, date_trunc('day', CURRENT_DATE), 1008, 'The Ultra Fast'); -- Every 10 minutes
